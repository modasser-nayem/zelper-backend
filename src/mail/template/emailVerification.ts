                    ...
                    <tr>
                        <td style="background-color: #f8f9fa; padding: 30px; text-align: center; border-top: 1px solid #e9ecef;">
                            <p style="color: #666666; margin: 0 0 15px; font-size: 14px;">
                                ...
                                <a href="mailto:${APP_CONFIG.SUPPORT_EMAIL}" style="color: #4f46e5; text-decoration: none;">${APP_CONFIG.SUPPORT_EMAIL}</a>
                            </p>
                            ...
                            <div style="margin: 20px 0;">
                             ...
                             <a href=${APP_CONFIG.DOMAIN} style="color: #4f46e5; font-size:14px; text-decoration: none;">${APP_CONFIG.WWW_DOMAIN}</a>
